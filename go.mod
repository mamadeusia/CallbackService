module github.com/mamadeusia/CallbackService
...
require (
	git.energy/corepass/go-micro-plugins/events/natsjs v0.0.0-20230516201617-25c7c17ee6ef // indirect
...
replace github.com/go-micro/plugins/v4/events/natsjs v1.2.0 => github.com/mamadeusia/plugins/v4/events/natsjs v0.0.0-20230516175851-538cc5e7aac7
